...
int main()
{
    ...
    while((wasd = getchar()) != 'q')
    {
        ...
        if(wasd == 'w')
        {
            ...
            if(map[i][j]==0)
            {
                ...
                if(appear_m == 2)
                {
                    ...
                    if(m_name == "대복이")
                    {
                        n = fight_boss(m_name, name, &hp1, &c_hp1, itemlist1);
                        if(n == 1)
                        {
                            printf("happy ending!!\n");
                            break;
                    ...
                    {
                        n = fight(m_name, name, &hp1, &c_hp1, itemlist1);
                        if(n == 1)
                        {
                            printf("승리하였습니다.\n");
                            map_print(map);
        ...
        {
            if(j==0){
                printf("탐험할 수 없는 곳입니다. 뒤로 돌아가주세요.\n");
                map_print(map);
                j++;
            }
            j--;
...
int fight_boss(char m_name[],char name[], int* hp, int* c_hp, int itemlist[])
{
    ...
    *c_hp =  *hp;
    ...
    while(1)
    {
        ...
        printf("%s 몬스타 출현. 적체력 %d 적 공격력 %.1f\n",m_name,m_hp,m_attack);
        printf("%s 의 현재 공격력 및 체력 %d %d\n",name,attack,*c_hp);
